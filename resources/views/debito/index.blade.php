...
@section('content')
    ...
    <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
            <h2 class="">Módulo de Notas de Débito</h2>
        </div>
        <div class="pull-right">
            <ol class="breadcrumb">
                <li><a href="/">Inicio</a></li>
                <li class="active">Emitir Notas de Débito</li>
            </ol>
        </div>
    </div>
    ...
    <script src="{{ asset('/lib/debito/debitoModel.js') }}"></script>
    <script src="{{ asset('/lib/debito/debitoController.js') }}"></script>
